<script lang="ts">
	import { StatCard } from '$lib/frontend/shared/ui';
	import { DIE_COLOR } from '$lib/frontend/shared/ui/dice-colors';
	import { computeExtended, sessionSummary, fmtLuck, luckClass, fmtDate } from '$lib/frontend/shared/lib/dice-utils';
	import type { BreakdownEntry, SessionLuck, SessionRecord } from '$lib/frontend/shared/lib/api-types';
	import { DieBreakdown } from '$lib/frontend/entities/die-roll';
	import { fetchRollSessions, fetchDashboard } from './statsDashboard.api';
...
<div class="px-4 py-6">
	<div class="mb-6 flex items-center justify-between">
		...
		<button
			...
			aria-label="Refresh stats">↻ Refresh</button
		>
	</div>
